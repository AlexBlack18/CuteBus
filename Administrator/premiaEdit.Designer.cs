namespace CuteBus.Administrator
{
    partial class premiaEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Windows.Forms.Label финальная_зарплатаLabel;
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(premiaEdit));
            ...
            this.финальная_зарплатаTextBox = new System.Windows.Forms.TextBox();
            ...
            финальная_зарплатаLabel = new System.Windows.Forms.Label();
            ...
            // id_сотрудникаLabel
            // 
            id_сотрудникаLabel.AutoEllipsis = true;
            id_сотрудникаLabel.AutoSize = true;
            id_сотрудникаLabel.BackColor = System.Drawing.Color.Transparent;
            id_сотрудникаLabel.Location = new System.Drawing.Point(360, 182);
            ...
            // зарплатаLabel
            // 
            зарплатаLabel.AutoEllipsis = true;
            зарплатаLabel.AutoSize = true;
            зарплатаLabel.BackColor = System.Drawing.Color.Transparent;
            зарплатаLabel.Location = new System.Drawing.Point(382, 208);
            ...
            // премияLabel
            // 
            премияLabel.AutoEllipsis = true;
            премияLabel.AutoSize = true;
            премияLabel.BackColor = System.Drawing.Color.Transparent;
            премияLabel.Location = new System.Drawing.Point(391, 234);
            премияLabel.Name = "премияLabel";
            премияLabel.Size = new System.Drawing.Size(48, 13);
            премияLabel.TabIndex = 50;
            премияLabel.Text = "премия:";
            // 
            // финальная_зарплатаLabel
            // 
            финальная_зарплатаLabel.AutoEllipsis = true;
            финальная_зарплатаLabel.AutoSize = true;
            финальная_зарплатаLabel.BackColor = System.Drawing.Color.Transparent;
            финальная_зарплатаLabel.Location = new System.Drawing.Point(323, 260);
            финальная_зарплатаLabel.Name = "финальная_зарплатаLabel";
            финальная_зарплатаLabel.Size = new System.Drawing.Size(116, 13);
            финальная_зарплатаLabel.TabIndex = 52;
            финальная_зарплатаLabel.Text = "финальная зарплата:";
            // 
            // button7
            // 
            ...
            // 
            this.id_сотрудникаTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.premiaBindingSource, "id сотрудника", true));
            this.id_сотрудникаTextBox.Location = new System.Drawing.Point(445, 179);
            this.id_сотрудникаTextBox.Name = "id_сотрудникаTextBox";
            this.id_сотрудникаTextBox.Size = new System.Drawing.Size(170, 20);
            this.id_сотрудникаTextBox.TabIndex = 47;
            // 
            // зарплатаTextBox
            // 
            this.зарплатаTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.premiaBindingSource, "зарплата", true));
            this.зарплатаTextBox.Location = new System.Drawing.Point(445, 205);
            this.зарплатаTextBox.Name = "зарплатаTextBox";
            this.зарплатаTextBox.Size = new System.Drawing.Size(170, 20);
            this.зарплатаTextBox.TabIndex = 49;
            // 
            // премияTextBox
            // 
            this.премияTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.premiaBindingSource, "премия", true));
            this.премияTextBox.Location = new System.Drawing.Point(445, 231);
            this.премияTextBox.Name = "премияTextBox";
            this.премияTextBox.Size = new System.Drawing.Size(170, 20);
            this.премияTextBox.TabIndex = 51;
            // 
            // финальная_зарплатаTextBox
            // 
            this.финальная_зарплатаTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.premiaBindingSource, "финальная зарплата", true));
            this.финальная_зарплатаTextBox.Location = new System.Drawing.Point(445, 257);
            this.финальная_зарплатаTextBox.Name = "финальная_зарплатаTextBox";
            this.финальная_зарплатаTextBox.Size = new System.Drawing.Size(170, 20);
            this.финальная_зарплатаTextBox.TabIndex = 53;
            // 
            // premiaEdit
            // 
            ...
            this.Controls.Add(финальная_зарплатаLabel);
            this.Controls.Add(this.финальная_зарплатаTextBox);
            ...
            this.Name = "premiaEdit";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Премия";
            this.Load += new System.EventHandler(this.premiaEdit_Load);
        ...
        private System.Windows.Forms.TextBox финальная_зарплатаTextBox;
    }
}